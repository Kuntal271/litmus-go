...
func GetENV(experimentDetails *experimentTypes.ExperimentDetails) {
	...
	experimentDetails.AuthURL = types.Getenv("AUTH_URL", "")
	experimentDetails.Username = types.Getenv("USERNAME", "")
	experimentDetails.Password = types.Getenv("PASSWORD", "")
	experimentDetails.ProjectID = types.Getenv("PROJECT_ID", "")
	experimentDetails.DomainName = types.Getenv("DOMAIN_NAME", "")
}
